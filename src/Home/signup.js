...
newsletter.main = document.querySelector('#validate');
newsletter.form = document.querySelector('#validate > .form');
newsletter.input = document.querySelector('#validate>.form>.input>input');
newsletter.submitButton = document.querySelector('#validate>.form>.input> button');
newsletter.successMessage = document.querySelector('#validate>.form>.class');
